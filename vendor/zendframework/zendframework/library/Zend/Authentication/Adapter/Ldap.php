...
class Ldap extends AbstractAdapter
{
    ...
    public function authenticate()
    {
        ...
        foreach ($this->options as $options) {
            ...
            if (!is_array($options)) {
                throw new Exception\InvalidArgumentException('Proxy options array not an array');
            }
     ...
     *
     * This resembles the feature {@see Zend\Authentication\Proxy\DbTable::getResultRowObject()}.
     * Closes ZF-6813
     *
